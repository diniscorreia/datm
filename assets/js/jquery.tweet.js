  ...
  $.fn.tweet = function(o){
    ...
    function extract_template_data(item){
      ...
      o.avatar = o.avatar_size ?
        t('<a class="tweet-avatar" href="{user_url}"><img src="{avatar_url}" height="{avatar_size}" width="{avatar_size}" alt="{screen_name}\'s avatar" title="{screen_name}\'s avatar" border="0"/></a>', o) : '';
      o.time = t('<h1 class="item-primary-title"><a href="{tweet_url}" title="View tweet on twitter"><time datetime="2012-01-25">{tweet_relative_time}</time></a></h1>', o);
      o.text = t('<div class="item-prose"><p>{tweet_text_fancy}</p></div>', o);
      o.reply_action = t('<a class="tweet-action tweet_reply" href="{reply_url}">reply</a>', o);
    ...
    return this.each(function(i, widget){
      ...
      $(widget).unbind("tweet:load").bind("tweet:load", function(){
        ...
        $.getJSON(build_api_url(), function(data){
          ...
          list.append($.map(tweets, function(o) { return '<li class="item-wrapper"><article class="tweet item">' + t(s.template, o) + "</article></li>"; }).join('')).
